...
The ADF Validator command-line tool allows validation of ADF and TTL files (based on TopQuadrant’s SHACL API https://github.com/TopQuadrant/shacl)
...
Please make sure that all required dependencies are located in folder “lib” next to adf-validator-0.2.2.jar.
